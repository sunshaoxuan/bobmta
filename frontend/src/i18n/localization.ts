...
export const UI_MESSAGE_KEYS = {
  ...
  navMenuOverview: 'frontend.nav.menu.overview',
  navMenuOperations: 'frontend.nav.menu.operations',
  navUserGuest: 'frontend.nav.user.guest',
  navLogin: 'frontend.nav.login',
  navAccessDeniedTitle: 'frontend.nav.accessDenied.title',
  navAccessDeniedDescription: 'frontend.nav.accessDenied.description',
  ...
  planDetailTimelineFilterLabel: 'frontend.plan.detail.timeline.filter.label',
  planDetailTimelineFilterAll: 'frontend.plan.detail.timeline.filter.all',
  planDetailTimelineFilterOption: 'frontend.plan.detail.timeline.filter.option',
  planDetailTimelineFilterReset: 'frontend.plan.detail.timeline.filter.reset',
  planDetailTimelineFilterEmpty: 'frontend.plan.detail.timeline.filter.empty',
  planDetailTimelineFilterNoMatch: 'frontend.plan.detail.timeline.filter.noMatch',
  planDetailTimelineHighlightHidden: 'frontend.plan.detail.timeline.highlight.hidden',
  ...
  planDetailReminderProcessing: 'frontend.plan.detail.reminders.processing',
  planDetailReminderSuccess: 'frontend.plan.detail.reminders.success',
  planDetailReminderError: 'frontend.plan.detail.reminders.error',
  planDetailReminderRetry: 'frontend.plan.detail.reminders.retry',
  planDetailReminderRetryEdit: 'frontend.plan.detail.reminders.retry.edit',
  planDetailReminderEditTitle: 'frontend.plan.detail.reminders.edit.title',
  planDetailReminderEditActiveLabel: 'frontend.plan.detail.reminders.edit.active',
  planDetailReminderEditOffsetLabel: 'frontend.plan.detail.reminders.edit.offset',
  planDetailReminderEditConfirm: 'frontend.plan.detail.reminders.edit.confirm',
  planDetailReminderEditCancel: 'frontend.plan.detail.reminders.edit.cancel',
  planCalendarGranularityDay: 'frontend.plan.calendar.granularity.day',
  planCalendarGranularityWeek: 'frontend.plan.calendar.granularity.week',
  planCalendarGranularityMonth: 'frontend.plan.calendar.granularity.month',
  planCalendarGranularityYear: 'frontend.plan.calendar.granularity.year',
  planDetailModeDesign: 'frontend.plan.detail.mode.design',
  planDetailModeExecution: 'frontend.plan.detail.mode.execution',
  planDetailModeDesignHint: 'frontend.plan.detail.mode.design.hint',
  planDetailModeExecutionHint: 'frontend.plan.detail.mode.execution.hint',
  planDetailNodesTitle: 'frontend.plan.detail.nodes.title',
  planDetailNodesTitleDesign: 'frontend.plan.detail.nodes.title.design',
  planDetailNodesTitleExecution: 'frontend.plan.detail.nodes.title.execution',
  planDetailNodesEmpty: 'frontend.plan.detail.nodes.empty',
  planDetailActionsTitle: 'frontend.plan.detail.actions.title',
  planDetailActionsTitleDesign: 'frontend.plan.detail.actions.title.design',
  planDetailActionsTitleExecution: 'frontend.plan.detail.actions.title.execution',
  ...
  planDetailActionProcessing: 'frontend.plan.detail.actions.processing',
  planDetailActionSuccess: 'frontend.plan.detail.actions.success',
  planDetailActionError: 'frontend.plan.detail.actions.error',
  planDetailActionRetry: 'frontend.plan.detail.actions.retry',
  planDetailActionRetryEdit: 'frontend.plan.detail.actions.retry.edit',
  ...
  planDetailActionDialogOperatorLabel: 'frontend.plan.detail.actions.dialog.operator.label',
  planDetailActionDialogOperatorPlaceholder: 'frontend.plan.detail.actions.dialog.operator.placeholder',
  planDetailActionDialogAssigneeLabel: 'frontend.plan.detail.actions.dialog.assignee.label',
  planDetailActionDialogAssigneePlaceholder: 'frontend.plan.detail.actions.dialog.assignee.placeholder',
  planDetailActionDialogResultLabel: 'frontend.plan.detail.actions.dialog.result.label',
  planDetailActionDialogCommentLabel: 'frontend.plan.detail.actions.dialog.comment.label',
  planDetailActionDialogConfirm: 'frontend.plan.detail.actions.dialog.confirm',
  planDetailActionDialogCancel: 'frontend.plan.detail.actions.dialog.cancel',
  ...
  planDetailNodeCurrentTag: 'frontend.plan.detail.nodes.tag.current',
  planDetailNodeCompletedHint: 'frontend.plan.detail.nodes.tag.completedHint',
  planDetailNodeEdit: 'frontend.plan.detail.nodes.action.edit',
  planDetailNodeEditing: 'frontend.plan.detail.nodes.action.editing',
