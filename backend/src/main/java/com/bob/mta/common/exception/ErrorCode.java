...
public enum ErrorCode {
    ...
    VALIDATION_ERROR(4003, "validation.failed"),
    CUSTOM_FIELD_VALUE_INVALID(4004, "custom_field.value_invalid"),
    ...
    TEMPLATE_NOT_FOUND(4046, "template.not_found"),
    TAG_NOT_FOUND(4047, "tag.not_found"),
    CUSTOM_FIELD_NOT_FOUND(4048, "custom_field.not_found"),
